...
> ❗ Biasanya digunakan ketika kita sudah tahu sampai mana berhentinya (batas akhir) iterasinya

### Syntax For Loop

for statement mempunyai 3 expression untuk mengimplementasikan loop
yaitu
